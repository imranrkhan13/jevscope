...
export const CURRENCY_HINTS = Object.freeze({
  ...
  HKD: "Hong Kong dollars (HK$ or HKD)",
  NZD: "New Zealand dollars (NZ$ or NZD)",
  ZAR: "South African rand (ZAR)",
  THB: "Thai baht (THB)",
  MYR: "Malaysian ringgit (RM or MYR)",
  PHP: "Philippine pesos (PHP)",
  KRW: "South Korean won (KRW)",
  TWD: "Taiwan dollars (NT$ or TWD)",
  PLN: "Polish zloty (PLN)",
  TRY: "Turkish lira (TRY)",
  BRL: "Brazilian reais (R$ or BRL)",
  MXN: "Mexican pesos (MX$ or MXN)",
